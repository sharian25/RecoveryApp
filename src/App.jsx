...
function App() {
  ...
  useEffect(() => {
    fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&lang=es&units=${units}&appid=55fed173dbbbae45d6acd4f1a920d2f1`
    )
  ...
  return (
    <div className="App">
      ...
      <ButtonsTemp onUnitsChange={handleUnitChange} />
